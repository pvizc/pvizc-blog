...
1. **Un modelo de verdad.** No distingue entre afirmaciones verdaderas y falsas.
2. **Un modelo de incertidumbre.** No sabe cuán seguro está de lo que dice.
3. **Un modelo de contraste.** No verifica sus respuestas contra el mundo real.
